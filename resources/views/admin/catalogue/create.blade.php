    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">New Catalogue</h3>
                <div class="col-sm-12">
                ...
                {{ Form::open(['route'=>'catalogues.store','method'=>'post', 'enctype'=>'multipart/form-data']) }}
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-9" style="padding-top: 10px;">
                        <div class="form-group col-md-10">
                            <label>Parent Catalogue<i class="reqr">*</i> </label>
                            {{ Form::select('parent_id',['select']+$catalogues->toArray(),null,['class' => 'form-control']) }}
                        </div>
                    </div>
                </div>
                <div class="row">
